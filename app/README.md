...
This document provides examples and patterns for implementing routers, repositories, and models. You can follow them but it is not mandatory. There are many good ways of doing those things.
...
<head>
    ...
    <title>{% block title %}KSI{% endblock %}</title>
    {% block head %}{% endblock %}
</head>
<body>
    {% include "navbar.html" %}
